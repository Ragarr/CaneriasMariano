...
class ladrillo_no_rompible(bloque):
    def __init__(self, coord: list) -> None:
        ...
        super().__init__(coord+[0, 48, 88, 55, 95, -1])
...
class ladrillo_rompible(bloque):
    def __init__(self, coord: list) -> None:
        ...
        super().__init__(coord+[0, 48, 88, 55, 95, -1])  # una vez que el profesor nos pase el archivo con los sprites
...
class ladrillo_con_monedas(bloque):
    def __init__(self, coord: list) -> None:
        ...
        super().__init__(coord + [0, 48, 88, 55, 95, -1])  # cambiar una vez nos den los sprites
