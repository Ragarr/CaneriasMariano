...
sprite_smario_agachado =sprite_smario_fuego_agachado= [0, 187, 82, 16, 31, azul]
sprite_smario_fuego_andando1=[0,207,4,17,31,azul]
...
sprite_smario_fuego_girando = [0, 228, 3, 15, 31, azul]
sprite_smario_fuego_saltando= [0,35,136,15,31,azul]
...
sprite_smario_agachado_i =sprite_smario_fuego_agachado_i= [0, 187, 82, -15, 31, azul]
sprite_smario_fuego_andando1_i = [0, 207, 4, -16, 31, azul]
sprite_smario_fuego_andando2_i = sprite_smario_fuego_disparando_i=[0, 0, 134, -15, 30, azul]
sprite_smario_fuego_quieto_i = [0, 168, 81, -16, 31, azul]
sprite_smario_fuego_girando_i = [0,228,3,-16,31,azul]
sprite_smario_fuego_saltando_i = [0, 35, 136, -15, 31, azul]
